...
function Test-PSREEAPhoneNumber
{
    ...
    process
    {
        ($Phone -match "^\+(3((0[0-9]{10})|([134][0-9]{9})|(2(?!7[07]|90[0-79])[1-9][0-9]{7,9})|5([0267][0-9]{8}|1[0-9]{9}|[349][0-9]{7,9}|8[0-9]{5,12})|6[0-9]{8,9}|7([01][0-9]{8}|2[0-9]{7})|8(5[0-9]{8,9}|6[0-9]{8})|9[0-9]{6,12})|4(([018][0-9]{9}|2([01][0-9]{9}|3[0-9]{7,12})|3[0-9]{4,13}|4[0-9]{7,10}|5[0-9]{8}|6[0-9]{6,9}|7[0-9]{4,12})))$")
    }
